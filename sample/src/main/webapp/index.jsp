                ...
                $.get('PopulateTable', function (responseJson) {
                    if (responseJson != null) {
                        ...
                        $.each(responseJson, function (key, value) {
                            var rowNew = $("<tr><td></td><td></td><td></td><td></td><td></td><td></td><td><a href='http://www.programming-free.com/2013/03/ajax-fetch-data-from-database-in-jsp.html'>update</a></td><td><a href='https://www.javatpoint.com'>delete</a></td></tr>");
